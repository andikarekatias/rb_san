...
ActiveRecord::Schema[7.0].define(version: 2023_06_27_062435) do
  ...
  create_table "spks", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.integer "kapal"
    t.string "voyage"
    t.integer "kegiatan"
    t.datetime "est_tiba"
    ...
    t.datetime "updated_at", null: false
    t.string "no_spk"
    t.index ["no_spk"], name: "index_spks_on_no_spk", unique: true
  end
